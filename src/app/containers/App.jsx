...
import ProductListView from 'app/components/ProductListView'; // Заменено на ProductListView
import ProductEditor from 'app/components/ProductEditor'; // Заменено на ProductEditor
              ...
              {state.componentDidMount && (
                  <IntlProvider>
                    ...
                    {!isFetchingUser && (
                        <Routes>
                          <Route
                              element={<ProductListView />} // Заменено на ProductListView
                              path={`${pageURLs[pages.productListView]}`} // Заменено на productListView
                          />
                          <Route
                              element={<ProductEditor />} // Заменено на ProductEditor
                              path={`${pageURLs[pages.productEditor]}/:mode/:productId`} // Заменено на productEditor и productId
                          />
                          <Route
                              element={<ProductEditor />} // Заменено на ProductEditor
                              path={`${pageURLs[pages.productEditor]}/:mode`} // Заменено на productEditor
                          />
                          <Route
                              element={<DefaultPage />}
